...
export default function BookingForm({ bookingOption, selectedSlot, onSuccess, onCancel }: BookingFormProps) {
  ...
  return (
    <div className="bg-white rounded-lg border p-6">
      <h2 className="text-xl font-semibold mb-4">Slutför bokning</h2>

      {/* Booking summary */}
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <h3 className="font-semibold text-blue-900">{bookingOption.label}</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Övriga upplysningar</label>
          <textarea
        ...
        <p className="text-xs text-gray-500">
          <span className="text-red-500">*</span> Du måste ange minst e-post eller telefon
        </p>
